...
\begin{correction}
   ...
   $\Sigma^*$ \nomenclature{$\Sigma^*$}{Monoïde des mots sur l'alphabet $\Sigma$ ($\Sigma^*=\bigcup_{n\in\N}\Sigma^n$)} est régulier par construction, mais n'est certainement pas un groupe.
\end{correction}